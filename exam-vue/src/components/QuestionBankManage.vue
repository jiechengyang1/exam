<template>
  <el-container>
    <el-header>
      ...
      <br>
      <el-button round type="primary" style="margin-top: 10px" icon="el-icon-plus" @click="addTableVisible = true">添加
      </el-button>
    ...
    <el-main style="margin-top: 20px">
      ...
      <el-dialog title="添加题库" :visible.sync="addTableVisible" width="30%" @close="$refs['addForm'].resetFields()"
        ...
        <div slot="footer" class="dialog-footer">
          <el-button round type="warning" @click="addTableVisible = false">取 消</el-button>
          <el-button round type="success" @click="addQuestionBank">确 定</el-button>
        </div>
      </el-dialog>
